...
import svc.MateReplyModifyProService;
...
public class MateReplyModifyAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		System.out.println("MateReplyModifyAction");
		...
		MateReplyModifyProService service = new MateReplyModifyProService();
		boolean isModifySuccess = service.isModifyReplyMate(reply_idx, nickname, content);
